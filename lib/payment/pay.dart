...
//  List<SubAccount> subAccounts = [];
  String email;
  double amount;
  String publicKey = "FLWPUBK-4026efed0cbdd6516e8714bbbbadd7e9-X";
  String encryptionKey = "a3b95dd95f7b447edcf9a4a4";
  String txRef;
  String orderRef;
//  String narration;
//  String currency;
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LightFleet(),),),
        ),
        title: Text("PROCESS YOUR PAYMENTS"),
      ),
      key: scaffoldKey,
      body: SafeArea(
        top: true,
